...
export class IncentiveDashboardTestComponent implements OnInit, OnChanges, OnDestroy {
  ...
  serviceIncluded = localStorage.getItem("serviceIncluded");
  renewalMonths='12';
  ...
  ngOnInit() {
    ...
    //populate fields using retrievedObject


    // setTimeout(() => {
    //   let dashboardSelectForLocalStorage = new IncentiveDashboard;
    //   dashboardSelectForLocalStorage.customer = this.incentiveDashboardTestForm.get('CustomerID').value;
    //   dashboardSelectForLocalStorage.site = "anysite";
    //   dashboardSelectForLocalStorage.system = "anysystem";
    //   dashboardSelectForLocalStorage.accountNumber = "123";
    //   dashboardSelectForLocalStorage.system = "Burglar Alarm";
    //   dashboardSelectForLocalStorage.panelType = "Panel Type Example";
    //   dashboardSelectForLocalStorage.location = "Panel Location Example";
    //   dashboardSelectForLocalStorage.centralStation = "New Location";
    //   console.log(dashboardSelectForLocalStorage);
    // }, 4);
  ...
  onChanges():void {
    ...
    //   return
    // } 
    this.incentiveDashboardTestForm.get('CustomerID').valueChanges.subscribe(val => {
      this.dashboardSelectForLocalStorage.customer = val;
    })

    this.incentiveDashboardTestForm.get('CustomerSiteID').valueChanges.subscribe(val => {
      this.dashboardSelectForLocalStorage.site = val;
    })

    this.incentiveDashboardTestForm.get('System').valueChanges.subscribe(val => {
      this.dashboardSelectForLocalStorage.system = val;
    })

    this.incentiveDashboardTestForm.get('AlarmAccount').valueChanges.subscribe(val => {
      this.dashboardSelectForLocalStorage.accountNumber = val;
    })

    this.incentiveDashboardTestForm.get('SystemType').valueChanges.subscribe(val => {
      this.dashboardSelectForLocalStorage.system = val;
    })

    this.incentiveDashboardTestForm.get('PanelType').valueChanges.subscribe(val => {
      this.dashboardSelectForLocalStorage.panelType = val;
    })

    this.incentiveDashboardTestForm.get('PanelLocation').valueChanges.subscribe(val => {
      this.dashboardSelectForLocalStorage.location = val;
    })

    this.incentiveDashboardTestForm.get('CentralStationID').valueChanges.subscribe(val => {
    ...
    this.incentiveDashboardTestForm.get('AdditionalInfo').valueChanges.subscribe(val => {
      console.log(val);
  ...
  onSubmit(form: FormGroup) {
    ...
    this.incentiveDashboardTestForm.controls["CustomerID"].setValue(this.id);
    this.incentiveDashboardTestForm.controls["ContractTerm"].setValue(0);
    // this.incentiveDashboardTestForm.controls["CustomerSiteID"].setValue(this.siteName);
    ...
    this.routeService.postIncentiveADDStart(this.incentiveDashboardTestForm.value).subscribe(
      result => {
        console.log(result)
        //returns the job id
        this.job_id = result;
                      ...
                      data => {
                        ...
                        this.routeService.postIncentive_ADD_Finish(updateIncentiveAddFinishWithJobID).subscribe(
                          result => {
                            ...
                            this.incentiveDashboardTestForm.reset();
                            this.reset();
                          }
                        )
                      }
    ...
    // this.routeService.postCustomerDocumentADD(this.incentiveDashboardTestForm.value).subscribe(
    //   result => {
    //     console.log(result)
    //   }
    // )
    ...
    // frmData.append('customer_id', this.incentiveDashboardTestForm.get('CustomerID').value);
    frmData.append('customer_id', this.id);

    frmData.append('customer_site_id', this.incentiveDashboardTestForm.get('CustomerSiteID').value);

    frmData.append('customer_system_id', this.incentiveDashboardTestForm.get('System').value);
  ...
  onSignalsTested(e) {
    ...
    let newSignalsTested = this.incentiveDashboardTestForm.controls['SignalsTested'].value;
  ...
  openAddViewCommentsModal(comments) {
    this.modalService.open(comments, {
      ...
      // console.log(result)
      // console.log(this.incentiveDashboardTestForm.controls['PartnerComments'].value)
      let newPartnerComments = this.incentiveDashboardTestForm.controls['PartnerComments'].value;
