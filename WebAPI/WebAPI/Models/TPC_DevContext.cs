    ...
    public partial class TPC_DevContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("Server=10.0.81.29;Database=TPC_Dev;User ID=cstith;Password=TPC$123tpc");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CheckBoxIncompatible>(entity =>
            {
                entity.ToTable("CheckBoxIncompatible");
                entity.HasNoKey();
            });
            ...
            modelBuilder.Entity<PartnerCriticalMessage>(entity =>
            {
                entity.HasNoKey();
            });

            modelBuilder.Entity<PartnerCustCareNote>(entity =>
            {
                entity.HasNoKey();
            });
