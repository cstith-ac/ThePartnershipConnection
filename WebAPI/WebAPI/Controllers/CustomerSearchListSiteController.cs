...
namespace WebAPI.Controllers
{
    ...
    [ApiController]
    public class CustomerSearchListSiteController : ControllerBase
    {
        ...
        public CustomerSearchListSiteController(
        ...
        [HttpGet]
        [Authorize]
        public async Task<Object> GetCustomerSearchListSites()
        {
            var list = new List<CustomerSearchListSites>();
            ...
            await using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                var site = "Site";
                var result = await db.GetCustomerSearchListSites.FromSqlRaw("EXECUTE dbo.CustomerSearchList @SearchField ='" + site + "' ").ToListAsync();
