...
namespace WebAPI.Controllers
{
    ...
    [ApiController]
    public class CallSummaryProblemsIVController : ControllerBase
    {
        ...
        public CallSummaryProblemsIVController(
        ...
        public async Task<Object> GetCallSummaryProblems()
        {
            ...
            await using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                var callClass = new SqlParameter("@CallClass", callSummaryClassList[2].Problem_Class_Code);
