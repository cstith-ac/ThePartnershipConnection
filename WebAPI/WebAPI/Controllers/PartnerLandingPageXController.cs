...
namespace WebAPI.Controllers
{
    ...
    public class PartnerLandingPageXController : ControllerBase
    {
        ...
        //[HttpGet]
        //[Authorize]
        //public async Task<Object> GetPartnerLandingPageXResult()
        //{
        //    var customers = new List<PartnerLandingPageX>();
        ...
        //        var c = user.UserName;
        //        var x = "hugo@cloudsecurityalarms.com";
        //        var result = await db.GetPartnerLandingPageXResult.FromSqlRaw("EXECUTE dbo.PartnerLandingPageX @UserEmail = '" + c + "', @AliasEmail = '" + x + "' ").ToListAsync();

        //        List<PartnerLandingPageX> Lst = result.Select(s => new PartnerLandingPageX
        //        {
