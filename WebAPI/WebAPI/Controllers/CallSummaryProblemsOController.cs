...
namespace WebAPI.Controllers
{
    ...
    [ApiController]
    public class CallSummaryProblemsOController : ControllerBase
    {
        ...
        public CallSummaryProblemsOController(
        ...
        public async Task<Object> GetCallSummaryProblems()
        {
            ...
            await using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                var callClass = new SqlParameter("@CallClass", callSummaryClassList[3].Problem_Class_Code);
